...
const Bike9 = (props) => {
    ...
    const [active1, setActive1] = useState('/images/4.png');
    const [select1, setSelect1] = useState(active1);
    const [active2, setActive2] = useState('/images/5.png');
    ...
    const widgetAnimationStyle2 = useSpring({
        config: {mass: 1, tension: 180, friction: 10},
        from: {translateX: 10, rotate: '-70.03deg', translateY: -300,opacity: 1},
        to: {
        ...
        <>
            <animated.div className="class">
                ...
                <animated.img  style={{
                    ...
                    height: 140,
                    opacity : s[0].opacity
                }} className={className} src={active} alt="logo"/>
                <animated.img style={{
                    ...
                    height: 140,
                    opacity : s[0].opacity
                }} className={classNam} src={active} alt="logo"/>
                ...
                <animated.img style={{
                    ...
                    opacity : f[0].opacity
                }} className={className1} src={active1} alt="logo"/>
                <animated.img style={{
                    rotate: widgetAnimationStyle2.rotate,
                    width: 500,
                    height: 310.2,
                    ...
                    opacity : d[0].opacity
                }} className={classNa} src={active2} alt="logo"/>
            </animated.div>

        </>
    )
}
export default Bike9;
