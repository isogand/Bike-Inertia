...
const BikeCart = ({babal, ...props}) => {
    ...
    const commentQuantity = useSelector(
        (state) => state.comment.items || []
    ).length;
    ...
    **/
    ...
    return (
        <>
            ...
            {open && (
                <>
                    <button className="back1" onClick={handleClick}>
                        <div className="svg">
                            <svg
                                width="20"
                                height="20"
                        ...
                        <div className="Back" style={{zIndex: 10}}>
                            Back
                        </div>
                    </button>
                    <div
                    ...
                    >
                        <div>
                            <button onClick={toggleCartHandler}>
                                {" "}
                                <img src={"/image/Comment.svg"} alt="rocket" />
                            </button>
                            <div className="absolute border border-gray-700 -top-2 ml-4 text-xs w-4 h-4 bg-white rounded-full flex items-center justify-center text-gray-700">
                                {commentQuantity}
                            </div>
                        </div>
                    </div>
                    ...
                    <>
                        ...
                        {showCart && (
                            <div
                                ...
                                className="w-80 rounded-3xl -top-3.5 border border-gray-300"
                            >
                                <Comment {...props} id={props.info.id} />
                            </div>
                        )}
                    </>
                )}
                ...
                <animated.div className="back">
                    <animated.div className={open ? "back" : "divii"}>
                        ...
                        >
                            ...
                            {open && (
                                <button className="select" onClick={handleOpen}>
                                    <div className="Bike">
                                        {open ? (
                                            <img
                                                className=" "
